...
# ==================================================================================
def createAudioTrackFromTranslation( region, transcript, sourceLangCode, targetLangCode, audioFileName, bucket_name ):
	...
	# Now translate it.
	translated_txt = translate.translate_text(Text=transcript_txt, SourceLanguageCode=sourceLangCode, TargetLanguageCode=targetLangCode)
	...
	if response["ResponseMetadata"]["HTTPStatusCode"] == 200:
		...
		#target file name that should be uploaded to S3
		fileName = "output/" + audioFileName
		uploadToS3(bucket_name, audioFileName, fileName)
	else:
...
# ==================================================================================
# Function: uploadToS3
# Purpose: Utility to write an audio file to S3 bucket
# Prrameters: 
#                 response - the Amazaon Polly JSON response  
#                 audioFileName - the name (including extension) of the target audio file (e.g. "abc.mp3")
# ==================================================================================
def uploadToS3(bucket_name, audioFileName, targetFileName):
    s3 = boto3.client('s3')
    with open("audioFileName", "rb") as f:
        s3.upload_fileobj(f, bucket_name, targetFileName)
